...
```bash
tar -xzf project-brain-v0.9.1-macos-arm64.tar.gz
mkdir -p ~/.local/bin
...
```bash
python -m pip install https://github.com/superorange0707/project-brain/releases/download/v0.9.1/project_brain_context-0.9.1-py3-none-any.whl
```
...
After upgrading to v0.9.1, rerun `brain agent-kit m365`, replace Instructions
and `PROJECT_KNOWLEDGE.md`, and optionally refresh Suggested Prompts. The kit's
`AGENT_KIT.json` identifies Brain 0.9.1, kit version 3, and protocol v4. Existing

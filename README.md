...
This source tree documents **v1.0.18** for macOS, Windows and Linux. Published
...
**[Download `project-brain-v1.0.18-windows-amd64.zip`](https://github.com/superorange0707/project-brain/releases/download/v1.0.18/project-brain-v1.0.18-windows-amd64.zip)**
...
[`SHA256SUMS.txt`](https://github.com/superorange0707/project-brain/releases/download/v1.0.18/SHA256SUMS.txt):
...
the [v1.0.18 Release assets](https://github.com/superorange0707/project-brain/releases/tag/v1.0.18).
...
```bash
python -m pip install https://github.com/superorange0707/project-brain/releases/download/v1.0.18/project_brain_context-1.0.18-py3-none-any.whl
```

All native archives, Python distributions, installers and their checksums are on the
**[v1.0.18 Release page](https://github.com/superorange0707/project-brain/releases/tag/v1.0.18)**.

...
This source tree documents **v1.0.24** for macOS, Windows and Linux. Published
...
```powershell
git clone --depth 1 --branch v1.0.24 https://github.com/superorange0707/project-brain.git project-brain-installer
cd project-brain-installer
.\scripts\install-project-brain.ps1 -Version 1.0.24
```
...
```powershell
.\scripts\install-project-brain.ps1 -ArchivePath "$env:USERPROFILE\Downloads\project-brain-v1.0.24-windows-amd64.zip"
```
...
**[Download `project-brain-v1.0.24-windows-amd64.zip`](https://github.com/superorange0707/project-brain/releases/download/v1.0.24/project-brain-v1.0.24-windows-amd64.zip)**
...
[`SHA256SUMS.txt`](https://github.com/superorange0707/project-brain/releases/download/v1.0.24/SHA256SUMS.txt):

```powershell
Get-FileHash .\project-brain-v1.0.24-windows-amd64.zip -Algorithm SHA256
```

On unrestricted machines, the same installer is also available directly from
the [v1.0.24 Release assets](https://github.com/superorange0707/project-brain/releases/tag/v1.0.24).

### Linux — verified user-level installer

```bash
curl -fsSLO https://github.com/superorange0707/project-brain/releases/download/v1.0.24/install-project-brain.sh
sh install-project-brain.sh --version 1.0.24
brain --version
```
...
```bash
uv tool install "project-brain-context @ git+https://github.com/superorange0707/project-brain.git@v1.0.24"
```

Or install the release wheel directly:

```bash
python -m pip install https://github.com/superorange0707/project-brain/releases/download/v1.0.24/project_brain_context-1.0.24-py3-none-any.whl
```

All native archives, Python distributions, installers and their checksums are on the
**[v1.0.24 Release page](https://github.com/superorange0707/project-brain/releases/tag/v1.0.24)**.

...
This source tree documents **v1.0.27** for macOS, Windows and Linux. Published
...
before stopping the UI. For the relationship refresh and M365 Agent Kit update
recommended with 1.0.27, follow the
[release upgrade notes](https://github.com/superorange0707/project-brain/releases/tag/v1.0.27).
...
```powershell
git clone --depth 1 --branch v1.0.27 https://github.com/superorange0707/project-brain.git project-brain-installer
cd project-brain-installer
.\scripts\install-project-brain.ps1 -Version 1.0.27
```
...
```powershell
.\scripts\install-project-brain.ps1 -ArchivePath "$env:USERPROFILE\Downloads\project-brain-v1.0.27-windows-amd64.zip"
```
...
**[Download `project-brain-v1.0.27-windows-amd64.zip`](https://github.com/superorange0707/project-brain/releases/download/v1.0.27/project-brain-v1.0.27-windows-amd64.zip)**
...
[`SHA256SUMS.txt`](https://github.com/superorange0707/project-brain/releases/download/v1.0.27/SHA256SUMS.txt):

```powershell
Get-FileHash .\project-brain-v1.0.27-windows-amd64.zip -Algorithm SHA256
```

On unrestricted machines, the same installer is also available directly from
the [v1.0.27 Release assets](https://github.com/superorange0707/project-brain/releases/tag/v1.0.27).

### Linux — verified user-level installer

```bash
curl -fsSLO https://github.com/superorange0707/project-brain/releases/download/v1.0.27/install-project-brain.sh
sh install-project-brain.sh --version 1.0.27
brain --version
```
...
```bash
uv tool install "project-brain-context @ git+https://github.com/superorange0707/project-brain.git@v1.0.27"
```

Or install the release wheel directly:

```bash
python -m pip install https://github.com/superorange0707/project-brain/releases/download/v1.0.27/project_brain_context-1.0.27-py3-none-any.whl
```

All native archives, Python distributions, installers and their checksums are on the
**[v1.0.27 Release page](https://github.com/superorange0707/project-brain/releases/tag/v1.0.27)**.
...
| [Release Notes](RELEASE_NOTES.md) | Current release changes and upgrade instructions |

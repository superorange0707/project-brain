# Project Brain v1.0.4 — Investigation Runtime
...
The v1.0.4 release also preserves exact compatibility with the previously
...
The v1.0.4 release workflow keeps the Windows repository root within Git for

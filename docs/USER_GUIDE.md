...
macOS, Windows, Linux and Python distributions are at **v1.0.21**.
...
Use the verified
[v1.0.21 Mac archives](https://github.com/superorange0707/project-brain/releases/tag/v1.0.21)
or [v1.0.21 Linux archives](https://github.com/superorange0707/project-brain/releases/tag/v1.0.21)
...
Download `project-brain-v1.0.21-windows-amd64.zip` and the published
...
Expand-Archive .\project-brain-v1.0.21-windows-amd64.zip -DestinationPath "$env:LOCALAPPDATA\ProjectBrain\bin"
...
```bash
pipx install "project-brain-context @ git+https://github.com/superorange0707/project-brain.git@v1.0.21"
```

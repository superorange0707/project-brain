...
Download `project-brain-v1.0.5-windows-amd64.zip` and the published
...
After upgrading to v1.0.5, rerun `brain agent-kit m365`, replace Agent Builder
Instructions and `PROJECT_KNOWLEDGE.md`, and optionally refresh Suggested
Prompts and `INVESTIGATION_PROTOCOL.md`. `AGENT_KIT.json` records Brain 1.0.5,

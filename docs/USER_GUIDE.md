...
macOS, Windows, Linux and Python distributions are at **v1.0.23**.
...
Use the verified
[v1.0.23 Mac archives](https://github.com/superorange0707/project-brain/releases/tag/v1.0.23)
or [v1.0.23 Linux archives](https://github.com/superorange0707/project-brain/releases/tag/v1.0.23)
...
Download `project-brain-v1.0.23-windows-amd64.zip` and the published
...
Expand-Archive .\project-brain-v1.0.23-windows-amd64.zip -DestinationPath "$env:LOCALAPPDATA\ProjectBrain\bin"
...
```bash
pipx install "project-brain-context @ git+https://github.com/superorange0707/project-brain.git@v1.0.23"
```

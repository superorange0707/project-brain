...
checked in the bounded batch against the official reference; batch/single
parity uses deterministic top, midpoint, and endpoint samples so 80-item pools
do not require 80 redundant model passes. The suite covers positive and

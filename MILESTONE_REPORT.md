...
- `v0.6.7` is the current published Core release. Its official Homebrew formula
  ...
  mutation.
- Project Brain v1.0.5 is implemented from exact v0.9.2 commit
  ...
  publication is authorized. The v1.0.5 release candidate additionally passed
  ...
  interval before the already-flushed startup token becomes visible.
